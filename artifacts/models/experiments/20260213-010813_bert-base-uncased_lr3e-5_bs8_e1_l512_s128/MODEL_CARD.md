...
- **Validation metrics**: EM=79.8581, F1=87.4961

## Training data sizes
- train examples: 87599
- eval examples: 10570
- train features (after sliding window): 87714
- eval features (after sliding window): 10626
- train feat/example: 1.001
- eval feat/example: 1.005
